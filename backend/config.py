...
# Where the "push to target" step sends records. Default: the stub API mounted in this same server.
TARGET_API_URL = os.getenv("TARGET_API_URL", "http://127.0.0.1:8000/target-api")
